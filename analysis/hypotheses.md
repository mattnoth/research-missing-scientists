...
- Combined defense/aerospace workforce is large. Nuclear Threat Initiative (NTI) staffer Scott Roecker noted the U.S. has "thousands of scientists" in the defense/nuclear workforce [T4 CBS News – Reported]. The combined workforce of LANL (~14,000), JPL (~6,000), Sandia (~15,500), and affiliated institutions is in the tens of thousands. No formal actuarial analysis has been performed.
...
- Several cases lack public explanation. [McCasland](../cases/mccasland.md) (highly cleared two-star general), [Reza](../cases/reza.md) (superalloy inventor with anomalous Find a Grave memorial), [Chavez](../cases/chavez.md), [Casias](../cases/casias.md), and [Garcia](../cases/garcia.md) remain unexplained as of this writing. The absence of explanation is not itself evidence of conspiracy; it is also not evidence of independence.
...
- Congressional investigators have publicly raised the possibility. Rep. [Eric Burlison](https://en.wikipedia.org/wiki/Eric_Burlison) stated the pattern "has all the hallmarks of a foreign operation" and identified China, Russia, and Iran as potential actors [T4 – Reported]. Former FBI Assistant Director [Chris Swecker](https://en.wikipedia.org/wiki/Chris_Swecker) characterized the cases as potential "modern-day espionage" [T4 – Reported].
...
- [Maiwald](../cases/maiwald.md) worked on JPL space instrumentation (SBG-VSWIR, AMR, HIFI/Herschel; THz technology), which is adjacent to but not directly propulsion [T1 – Confirmed].
- [Loureiro](../cases/loureiro.md) was Director of MIT PSFC, which conducts DOE/ARPA-E-funded fusion research; SPARC tokamak partnership [T1 – Confirmed via MIT].
...
- DeLonge–Podesta email (January 2016) names [McCasland](../cases/mccasland.md) as having "helped assemble my advisory team" and as "very, very aware" of the project [T1 – Confirmed via WikiLeaks].
...
- [Eskridge](../cases/eskridge.md) made on-record claims of antigravity research and unspecified threats on a YouTube podcast in 2020 [T4 published interview – Reported]. These were the subject's own pre-death statements.
...
- [Steven Greer](https://en.wikipedia.org/wiki/Steven_M._Greer) has publicly alleged that some disappearances involve "transnational criminal organizations" suppressing UAP research [T4 Fox News – Reported].
...
- Individual explanations exist or are plausible for most cases:
  - [Grillmair](../cases/grillmair.md): Named suspect, criminal escalation pattern [T1/T3 – Confirmed]
  - [Loureiro](../cases/loureiro.md): Named suspect, personal grudge, video confession [T1 DOJ – Confirmed]
  - [Thomas](../cases/thomas.md): Personal grief, no defense connection, no foul play suspected by DA [T1 Middlesex DA – Confirmed]
  - [Eskridge](../cases/eskridge.md): Ruled suicide; father has publicly rejected conspiracy framings [T4 – Reported]
  - [Hicks](../cases/hicks.md): Cause undisclosed; no affirmative public evidence of foul play; left JPL a year before death; Al-Anon donation request may indicate personal context [T1 obituary]
  - [Maiwald](../cases/maiwald.md): Cause undisclosed; no affirmative public evidence of foul play [T1 obituary]
...
- Cases that resist individual explanation:
  - [McCasland](../cases/mccasland.md): Highly cleared retired general who left home with wallet and revolver but without phone and glasses, after reporting "mental fog." Wife stated he "planned not to be found" but denied dementia [T3 – Reported].
  - [Reza](../cases/reza.md): Disappeared mid-hike with witnesses; anomalous Find a Grave memorial four days post-disappearance; cell-phone forensic data obtained but not released [T4/T7].
  - [Garcia](../cases/garcia.md): If KCNSC employment claim is accurate, the disappearance is unexplained; the employment claim is unverified [T6].
...
- [Eskridge](../cases/eskridge.md) made on-record claims of antigravity research and unspecified threats on YouTube before her 2022 death [T4 – Reported]. These were the subject's own statements, predating her death by approximately two years.
- Rep. Burlison stated on-record that [McCasland](../cases/mccasland.md) "is connected to the UAP topic" and "has a lot of information"; the McCasland case remains genuinely unexplained as of this writing [T4 – Reported].
