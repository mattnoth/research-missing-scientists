*Snapshot 2026-05-08. Current: [analysis/connection-analysis.md](../../../../analysis/connection-analysis.md). Tag: [dossier-2026-05-08-pre-rebalance](https://github.com/mattnoth/research-missing-scientists/releases/tag/dossier-2026-05-08-pre-rebalance).*
...
## Tight Layer -- Documented, Verifiable Overlaps

These connections are confirmed by primary or credible secondary sources.

### Institutional Co-Employment
...
### Documented Shared Programs or Projects

| Connection | Individuals | Evidence | Confidence |
|---|---|---|---|
| None documented | -- | No two subjects have been shown to work on the same specific program, project, or contract | **High confidence in the absence** |

This is significant. Despite institutional co-employment at JPL and LANL, no source has documented that any two subjects worked together, shared a lab, participated in the same program, or had a professional relationship. The one exception is a speculative claim about a Reza-McCasland professional connection (see Medium Layer below).

---

## Medium Layer -- Research-Domain Adjacencies and Behavioral Parallels

These connections require inference beyond documented facts but are grounded in reported information.

### Propulsion / Advanced Materials Domain
...
## Corkboard Layer -- Speculative Connections

These connections are drawn from social media narratives, independent media, UAP-community theorizing, or inferences that go substantially beyond documented evidence. They are included for completeness and to make the speculative reasoning transparent, not because they are supported.

### UAP / Disclosure Adjacency
...
1. Geographic and institutional clustering is real but largely explainable by where defense/aerospace institutions are located.
2. The temporal clustering in 2025-2026 is real and is the strongest objective feature of the dataset.
3. Behavioral parallels (leaving without belongings) exist in multiple cases but are common in personal-crisis disappearances.
4. Two cases (Grillmair, Loureiro) have named suspects with strong non-conspiracy explanations supported by ballistic evidence and, in one case, a video confession.
5. One case (Thomas) involves a pharmaceutical researcher with no defense connection whose disappearance followed severe personal grief, with no foul play suspected by DA.

### What the evidence does not support:
1. No documented professional connection between any two subjects (no shared project, lab, or confirmed personal acquaintance).
2. No common operational signature across cases (methods range from shooting to hiking disappearance to walking away from home).
3. No law enforcement or intelligence agency has identified a connection between any cases.
4. No physical evidence of third-party involvement has been publicly disclosed in any unsolved case.
